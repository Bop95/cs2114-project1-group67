...
public class MatchTest extends TestCase
{
    ...
    /** Creates two people with shared and different preferences. */
    public void setUp()
    {
    ...
    /** Tests the original team getter method names. */
    public void testOriginalTeamGetterNames()
    {
        Match match = new Match(alex, blake);
        assertEquals(alex, match.getPerson1());
        assertEquals(blake, match.getPerson2());
        assertEquals(60.0, match.getCompatabilityScore(), 0.01);
    }
